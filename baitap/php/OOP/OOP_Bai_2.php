	...
	<?php 
	 ...
	 <form action="" method="POST">
	 	<div class="grid-container-4">
	 		...
	 		<div class="grid-item text-right">Tử số:</div>
	 		<div class="grid-item"><input type="number" value="<?php echo($tsa) ?>" name="tuSoA" required></div>
	 		<div class="grid-item text-right">Mẫu số:</div>
	 		<div class="grid-item"><input type="number" value="<?php echo($msa) ?>" name="mauSoA" required></div>

	 		<div class="grid-item item1-5"><hr size="1"></div>
	 		<div class="grid-item item1-5"><h4>Nhập phân số thứ 2:</h4></div>

	 		<div class="grid-item text-right">Tử số:</div>
	 		<div class="grid-item"><input type="number" value="<?php echo($tsb) ?>" name="tuSoB" required></div>
	 		<div class="grid-item text-right">Mẫu số:</div>
	 		<div class="grid-item"><input type="number" value="<?php echo($msb) ?>" name="mauSoB" required></div>

	 		<div class="grid-item item1-5 mt-1">
	 			<fieldset>
